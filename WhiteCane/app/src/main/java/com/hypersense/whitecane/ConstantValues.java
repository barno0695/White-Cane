...
public class ConstantValues {
    public static final String KEY_SHARED_PREF = "WhiteCanePref";
    public static final String KEY_MODE = "modeKey";
    public static final String KEY_OCRPP_JSON = "ocrppJsonKey";
    public static final String APP_LUIS_MAIN = "xxx";
    public static final String APP_LUIS_FACE = "xxx";
    public static final String APP_LUIS_OCRPP = "xxx";
    public static final String MODE_FACE = "face";
    public static final String MODE_MAIN = "main";
    public static final String MODE_OCRPP = "ocrpp";
